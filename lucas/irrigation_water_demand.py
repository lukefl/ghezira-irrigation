...
def crop_water_demand(crop, temp, rh, year, day):
    """
...
def irrigation_water_demand(crop, temp, rh, year, day, er, eff):
    """
    ...
    efficiency eff
    """
    return (crop_water_demand(crop, temp, rh, year,day) - er) / eff
